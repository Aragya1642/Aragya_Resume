...
%-----------RELEVANT EXPERIENCE-----------------
%TODO: Some weird spacing issues exist here - need to trace and eliminate
\section{Relevant Experience}
    \resumeSubHeadingListStart
        \resumeSubheading
            {Carnegie Mellon University - Robotics Institute}{Pittsburgh, PA}
            {Undergraduate Researcher (Part-time, Summer Internship)}{April 2023 - Present}
            \resumeItemListStart
...
\vspace{-5pt}
        \resumeSubheading
            {Society of Astronautics and Rocketry}{Remote}
            {Chief Engineer (Student Club)}{August 2022 -  Present}
            \resumeItemListStart
