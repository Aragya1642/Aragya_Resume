        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{ZOË 2 Rover}{\myLink{tinyurl.com/zoe2rover}}
                    \begin{itemize}
                      \item Developing low-level software stack for the 2nd generation Zoë Rover set to conduct science in the Atacama Desert including \underline{CAN} protocols via the \underline{ros\_canopen} package for \underline{ROS2} to communicate with encoders and motors.
                      \item Developed and conducted validation of motor and motor controller datasheet specifications via physical testing.
                    \end{itemize}
                \resumeItem{Underwater Snake Robot}{\myLink{tinyurl.com/humrsCMU}}
                    \begin{itemize}
                      \item Implemented \underline{High-Frequency Injection} methods in Brushless DC thrusters to achieve control at low/zero speeds thus reducing minimum speed by 80\% allowing for improved overall performance of the robot.
...
% \vspace{4pt}
        \resumeSubheading
            ...
            {Chief and Integration Engineer}{August 2022 -  Present}
            \resumeItemListStart
