...
%   \begin{subfigure}[b]{0.5\textwidth}
%       \centering
%       \includegraphics[width=6.5cm, height=6.5cm]{Apple.png}
...
%   \begin{subfigure}[b]{0.5\textwidth}
%       \centering
%       \includegraphics[width=6.5cm, height=6.5cm]{EBrakeBias.png}
%       \caption{E-Brake Bias}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.5\textwidth}
%       \centering
%       \includegraphics[width=6.5cm, height=6.5cm]{CustomCane.png}
%       \caption{Custom Cane}
%   \end{subfigure}
...
%   \begin{subfigure}[b]{0.5\textwidth}
%       \centering
%       \includegraphics[width=6.5cm, height=6.5cm]{DewbotXVII.png}
%       \caption{Dewbot XVII}
%   \end{subfigure}
%   \begin{subfigure}[b]{0.5\textwidth}
%       \centering
%       \includegraphics[width=6.5cm, height=6.5cm]{VEX.png}
