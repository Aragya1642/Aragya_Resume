...
\vspace{4pt}
        \resumeSubheading
            {Formula Society of Automotive Engineers}{Pittsburgh, PA}
            {R\&D Engineer}{August 2022 -  Present}
            \resumeItemListStart
                \resumeItem{E-Brake Bias Project}{\myLink{some}}
                    \begin{itemize}
                      \item niduewbiu
                      \item dewd
                    \end{itemize}
                \resumeItem{Low-Cost Slip Angle Sensor Project}{\myLink{some}}
                    \begin{itemize}
                      \item njdewhj 
                      \item dewdew
                    \end{itemize}
...
% \vspace{4pt}
        \resumeSubheading
            ...
            {Team Captain/Design Lead (Student Led Organization)}{August 2018 -  June 2022}
            \resumeItemListStart
              \resumeItemWithoutTitle {Designed six robots in \textbf{Solidworks} across four years. All robots qualified for higher level of competition including Worlds.}
              ...
              \resumeItemWithoutTitle {Won the VEX Judges Award, FIRST Excellence in Engineering Award, FIRST Industrial Design Award, and the FIRST Chairman's Award.}
            \resumeItemListEnd
    \resumeSubHeadingListEnd
\vspace{-5pt}
