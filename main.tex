        ...
        \resumeSubheading
            ...
            \resumeItemListStart
                \resumeItem{ZOË 2 Rover}{\myLink{https://tinyurl.com/zoe2rover}}
                    \begin{itemize}
                      \item Developing software stack for the 2nd generation Zoë Rover including low-level \underline{CAN communication} protocols via the \underline{ros\_canopen} package to communicate with encoders and motors.
                ...
                \resumeItem{Underwater Snake Robot}{\myLink{http://tinyurl.com/humrsCMU}}
                    \begin{itemize}
                      \item Implemented High-Frequency Injection methods in BLDC thrusters to achieve control at low/zero speeds thus reducing minimum speed by 80\% allowing for improved overall performance of the robot.
                      \item Implemented station-keeping feature using AprilTags, IMU readings, and Nested PID Controllers to perform state-estimation underwater.
